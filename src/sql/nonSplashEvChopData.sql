...
where ev.TRANSACTION_TYPE_ID IN (175, 213) and ev.CREATED_DATE <= '2025-05-26 20:00:00' and ev.CREATED_DATE >= '2025-05-22 06:00:00')
and ev.TRANSACTION_TYPE_ID = (176) and ev.CREATED_DATE <= '2025-05-26 20:00:00' and ev.CREATED_DATE >= '2025-05-22 06:00:00' and ev.IS_PROCESSED != 0)
and TRANSACTION_TYPE_ID IN (208) and CREATED_DATE <= '2025-05-26 20:00:00' and CREATED_DATE >= '2025-05-22 06:00:00' and TRANSACTION_AMOUNT=0)
AND CREATED_DATE <= '2025-05-26 20:00:00' and CREATED_DATE >= '2025-05-22 06:00:00') AS q1
INNER JOIN
...
from ev_operator.evchop_transactions_log ev where 
ev.TRANSACTION_ID NOT IN (select ev.TRANSACTION_ID from ev_operator.evchop_transactions_log ev 
where ev.TRANSACTION_TYPE_ID IN (175, 213) and ev.CREATED_DATE >= '2025-05-22 06:00:00' and ev.CREATED_DATE <= '2025-05-26 20:00:00')
and ev.TRANSACTION_TYPE_ID = (176) and ev.CREATED_DATE >= '2025-05-22 06:00:00' and ev.CREATED_DATE <= '2025-05-26 20:00:00'  and ev.IS_PROCESSED != 0)
and TRANSACTION_TYPE_ID IN (208) and CREATED_DATE >= '2025-05-22 06:00:00' and CREATED_DATE <= '2025-05-26 20:00:00'  and TRANSACTION_AMOUNT=0)
